...
export const seed = [
  ...
  /* base64 body, like a real upload — the preview pipeline decodes with atob */
  { id: 14, type: "doc", title: "Dashboard mockup", meta: "Latest design frame — open to preview", tags: ["design"], status: "Inbox", date: rel(-4), file: { name: "dashboard-mockup.svg", size: 484, type: "image/svg+xml", data: "data:image/svg+xml;base64," } },
